...
def main() -> None:
    ...
    # The uploaded notebook filters Jun-Sep. It uses "2012-06-00" / "2019-06-00" as a lower bound string.
    # Here we convert to real timestamps and use Jun 1, which matches the notebook's intent.
    ...
    # The notebook later reads these two CSVs from disk, so save them to stay close to the author's path.
    ...
    print('[4/6] Building modified case14 and generating load/PV arrays...')
    ...
    print('[5/6] Computing noise_sigma exactly the way the notebook does it...')
    ...
    print('\n[OK] Saved files under gen_data/case14:')
    ...
    print('\nNext step: run the author\'s own measurement generator:')
